...
class Replacement(General):
    ...
    def decrypt(self):
        ...
        if result.get("cipher") != "Replacment":
...
class Transposition(General):
    ...
    def encrypt(self):
        ...
        try:
            if key.get("cipher") != "Transposition":
                print("Error: Incorrect '.key' file!")
                return -1
        except:
            print("Error: Incorrect cipher in '.key' file!")
    ...
    def decrypt(self):
        ...
        if encr_text.get("cipher") != "Transposition":
            print("Error: Incorrect cipher in '.encrypt' file!")
            return -1
...
class interface(Replacement, Transposition, Gamma):
    def __init__(self):
    ...
    def menu_encrypt(self, CHOICE=None):
        if CHOICE == 1:
            checker = Replacement.encrypt(self)

        elif CHOICE == 2:
            checker = Transposition.encrypt(self)

        elif CHOICE == 3:
            checker = Gamma.encrypt(self)
    ...
    def menu_decrypt(self, CHOICE=None):
        if CHOICE == 1:
            checker = Replacement.decrypt(self)

        elif CHOICE == 2:
            checker = Transposition.decrypt(self)

        elif CHOICE == 3:
            checker = Gamma.decrypt(self)
    ...
    def menu_gen_key(self, CHOICE=None):
        if CHOICE == 1:
            checker1 = Replacement.generate_key(self)

        elif CHOICE == 2:
            checker1 = Transposition.generate_key(self)

        elif CHOICE == 3:
            checker1 = Gamma.generate_key(self)
